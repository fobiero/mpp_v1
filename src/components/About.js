        ...
        <div className="row">
          ...
          <div className="col-md-6 thumb-info-dt">
            ...
            <p className="about-info">
              ...
              <i>
                {" "}
                <small>Path for Peace (MPP) </small>{" "}
              </i>{" "}
              is a non-profit, non-governmental and local humanitarian
              organization working towards peacebuilding and non-violent actions
              in the Nuba Mountains, Sudan. We redirect young people’s energy
              from conflict to societal sustainable development through
              creativity and forward-thinking. Our thematic area is
              ...
              areas of focus are aligned to Sustainable Development Goals
              (SDGs). <br /> <br />
